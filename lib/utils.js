...
/**
 * Calculate token advance amount (30%)
 */
export function calcTokenAdvance(ourPrice) {
  return Math.round(ourPrice * 0.3);
}
...
🔗 *Track Order Live:*
https://${process.env.NEXT_PUBLIC_VERCEL_PROJECT_PRODUCTION_URL || 'onlygadjets.in'}/track/${orderId}`;
