  ...
  return (
    <div style={{ paddingBottom: 80, background: 'var(--bg-page)', fontFamily: 'var(--font-base)' }}>
      ...
      <div className="heroSection" style={{
        background: 'radial-gradient(circle at 70% 50%, var(--hero-bg-start) 0%, var(--hero-bg-end) 70%)',
        ...
        <div style={{ flex: '1 1 500px' }}>
          ...
          <div className="hero-features-grid">
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: 'var(--hero-text)', fontSize: '16px' }}>
        ...
        <div className="hero-image-container" style={{ flex: '1 1 400px', display: 'flex', justifyContent: 'center' }}>
          <Image src="/hero_devices.png" alt="High-Tech Devices" width={500} height={400} style={{ objectFit: 'contain', width: '100%', height: 'auto', dropShadow: '0 20px 40px rgba(0,0,0,0.5)' }} priority className="hero-image" />
        </div>
      </div>
      ...
      <div style={{ padding: '20px 40px' }}>
        <div style={{ background: 'var(--deal-bg)', borderRadius: '16px', padding: '32px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '32px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            <ShieldCheck size={36} color="var(--brand-accent)" />
            <div>
              <div style={{ color: 'var(--deal-text)', fontWeight: 700, fontSize: '15px' }}>Verified B2B-only</div>
              <div style={{ color: 'var(--deal-muted)', fontSize: '13px' }}>Verified for retailer only pricing</div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
              <div style={{ color: 'var(--deal-text)', fontWeight: 700, fontSize: '15px' }}>Nationwide Shipping</div>
              <div style={{ color: 'var(--deal-muted)', fontSize: '13px' }}>Secure transit across India</div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
              <div style={{ color: 'var(--deal-text)', fontWeight: 700, fontSize: '15px' }}>Flexible Payments</div>
              <div style={{ color: 'var(--deal-muted)', fontSize: '13px' }}>Pay 50% advance, rest on delivery</div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
              <div style={{ color: 'var(--deal-text)', fontWeight: 700, fontSize: '15px' }}>100% Quality Authenticity</div>
              <div style={{ color: 'var(--deal-muted)', fontSize: '13px' }}>Quality guaranteed on every unit</div>
            </div>
          </div>
        </div>
      </div>
